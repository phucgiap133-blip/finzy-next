      ...
      <PageContainer className="space-y-md">
        <div className="rounded-2xl border border-border bg-white p-md">
          <p className="text-caption text-text-muted">
            Lệnh rút thường xử lý trong <b>5–30 phút</b>. Một số ngân hàng có thể mất
        ...
        <div className="flex gap-sm">
          <Link href="/support/chat" className="px-md py-sm rounded-control border border-border text-center flex-1 text-body">
            Chat ngay
          </Link>
          <EmailSmartButton
