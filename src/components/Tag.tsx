...
export default function Tag({ children, tone = "neutral" }: { children: ReactNode; tone?: Tone }) {
  ...
  return <span className={"rounded-control px-sm py-xs text-sm " + tones[tone]}>{children}</span>;
}
