export default function Input({ label, placeholder, type = "text", value, onChange, error, hint, left, right }) {
  return (
    <label className="block">
      ...
      <div className="flex items-center gap-sm rounded-control border border-border bg-bg-card px-md py-sm shadow-sm focus-within:shadow-md">
        ...
        <input className="w-full bg-transparent outline-none text-md placeholder:text-text-muted" placeholder={placeholder} type={type} value={value} onChange={onChange} />
